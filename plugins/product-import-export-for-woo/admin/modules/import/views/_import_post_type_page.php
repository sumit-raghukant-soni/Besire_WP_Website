...
<div class="wt_iew_import_main">
	...
	<table class="form-table wt-iew-form-table">
		<tr>
			<th><label><?php _e( 'Select a post type to import', 'product-import-export-for-woo' ); ?></label></th>
			<td>
	...
	$wt_iew_post_types = array(
		...
		'subscription' => array(
			'message' => __( 'The <b>Order, Coupon, Subscription Export Import for WooCommerce</b> premium is required to import WooCommerce Subscriptions.', 'product-import-export-for-woo' ),
